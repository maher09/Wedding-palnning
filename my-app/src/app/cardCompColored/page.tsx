...
function CardCompColored() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const DatePattern =
      /^\s*(0?[1-9]|[12][0-9]|3[01])\s*[- /.]\s*(0?[1-9]|1[012])\s*[- /.]\s*(19|20)\d\d\s*$/;
    const TimePattern =
      /^\s*(0?[1-9]|1[0-2])\s*:\s*([0-5]\d)\s*[-/]\s*(0?[1-9]|1[0-2])\s*:\s*([0-5]\d)\s*$/i;
    ...
    try {
      const response = await axios.post(
        "http://localhost:3000/cardCompColored",
        {
          userEmail: Email,
          theBride: theBride,
          theGroom: theGroom,
                ...
                >
                  ...
                  <div>
                    ...
                    <label
                      ...
                      htmlFor="design"
                    >
                      Design color :{/* COLOR NAME empty span*/}
                      <span
                        id="compo-color"
                  ...
                  >
                    ...
                    <select
                      className="form-select form-select form-select"
                      id="floatinginput"
                      value={selectedPrice}
                      onChange={handlePriceChange}
                    >
                      <option value={"25 items - 5.99"}>
                        25 items - 5.99${" "}
                      </option>
                      <option value={"50 items - 10.99"}>
                        50 items - 10.99${" "}
                      </option>
                      <option value={"75 items - 15.99"}>
                        75 items - 15.99${" "}
                      </option>
                      <option value={"100 items -20.99"}>
                        100 items -20.99${" "}
                      </option>
                      <option value={"150 items - 25.99$"}>
                        150 items - 25.99${" "}
                      </option>
                      <option value={"200 items - 29.99$"}>
                        200 items - 29.99${" "}
                      </option>
                      <option value={"250 items - 34.99$"}>
                        250 items - 34.99${" "}
                      </option>
                      <option value={"300 items - 38.99$"}>
                        300 items - 38.99${" "}
                      </option>
                      <option value={"350 items - 42.99$"}>
                        350 items - 42.99${" "}
                      </option>
                      <option value={"400 items - 47.99$"}>
                        400 items - 47.99${" "}
                      </option>
                      <option value={"450 items - 52.99$"}>
                        450 items - 52.99$
                      </option>
                      <option value={"500 items - 57.99$"}>
                        500 items - 57.99$
                      </option>
                      <option value={"550 items - 60.99$"}>
                        550 items - 60.99$
                      </option>
                      <option value={"600 items - 62.99$"}>
                        600 items - 62.99$
                      </option>
                    </select>
